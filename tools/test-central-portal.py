...
class CentralPortalTests(unittest.TestCase):
    ...
    def _write_bound_bundle(self) -> tuple[Path, Path]:
        files = {
            "io/github/leminity/realm/realm-annotations/10.19.0-agp9.3/realm-annotations-10.19.0-agp9.3.jar": b"jar",
            "io/github/leminity/realm/realm-annotations/10.19.0-agp9.3/realm-annotations-10.19.0-agp9.3.pom": b"pom",
            "io/github/leminity/realm/realm-android-library/10.19.0-agp9.3/realm-android-library-10.19.0-agp9.3.aar": b"public-aar",
        }
    ...
    def test_stage_is_one_user_managed_upload_and_never_publishes(self) -> None:
        ...
        self.assertEqual(parse_qs(urlparse(upload_url).query), {"name": ["v10.19.0-agp9.3"], "publishingType": ["USER_MANAGED"]})
        ...
        self.assertTrue(
            (
                ...
                / "io/github/leminity/realm/realm-android-library/10.19.0-agp9.3/realm-android-library-10.19.0-agp9.3.aar"
            ).is_file()
        )
