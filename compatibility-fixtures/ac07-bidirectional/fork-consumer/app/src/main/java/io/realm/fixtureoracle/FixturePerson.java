...
/**
 * Deliberately retains the official fixture model's fully-qualified class name.
 * Realm's schema identity must remain stable across the official and fork readers.
 */
